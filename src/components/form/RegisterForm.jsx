export default function RegisterForm({ formData, handleChange, handleSubmit }) {
  return (
    <div className="flex justify-center items-center mt-100px mb-100px">
      <div className="w-600 h-1100 bg-white p-8 justify-center items-center relative border border-gray-300 rounded-lg">
        <h2 className="text-2xl font-bold mb-4">회원가입 JOIN</h2>
        <div className="border-b-4 border-yellow-500"></div>
        <form onSubmit={handleSubmit}>
          ...
          <div className="border-b-4 border-yellow-500 mb-4"></div>
          ...
          <div className="border-b-4 border-yellow-500 mb-4"></div>
          <button type="submit" className="w-full h-60 bg-yellow-500 text-white font-bold rounded mt-40px">
            회원가입
          </button>
        </form>
      </div>
